...
1. 在 On-premises Exchange Connector 支援的 Windows Server 作業系統上，以使用者帳戶開啟 [Microsoft Intune 管理主控台](https://manage.microsoft.com) (https://manage.microsoft.com))，這個使用者帳戶是 Exchange 租用戶中具有使用 Exchange Server 之授權的系統管理員。

...
|         <strong>Windows 應用程式套件 (.appx、.appxbundle)</strong>          |                                                                                                                                                                                                                                                                                                                                                                 若要部署應用程式，您需要企業行動程式碼簽署憑證。 如需詳細資訊，請參閱[使用 Microsoft Intune 設定 Windows 裝置管理](set-up-windows-device-management-with-microsoft-intune.md)。                                                                                                                                                                                                                                                                                                                                                                  |

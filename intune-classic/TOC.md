...
# 計劃和設計
## [部署規劃、設計和實作](plan-design/introduction.md)
...
## [移轉](plan-design/intune-mdm-migration-guide.md)
### [階段 1：為 MDM 準備 Intune](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [基本設定](plan-design/migration-phase1-basic-setup.md)
#### [設定裝置與應用程式管理原則](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [設定應用程式保護原則](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [特殊移轉考量](plan-design/migration-phase1-special-migration-considerations.md)
### [階段 2：移轉活動](plan-design/migration-phase2-migration-campaign.md)
#### [通訊計畫](plan-design/migration-phase2-communication-plan.md)
#### [促使採用](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [典型移轉週期](plan-design/migration-phase2-typical-migration-cycle.md)

# [新功能](whats-new/whats-new-in-microsoft-intune.md)
## [應用程式 UI 的新功能](whats-new/whats-new-in-intune-app-ui.md)
## [Azure 預覽的新功能](/intune/whats-new?toc=/intune-classic/toc.json&bc=/enterprise-mobility/toc.json)
...
#### [建立與指派適用於 Windows 10 的 WIP 應用程式保護原則](deploy-use/create-windows-information-protection-policy-with-intune.md)

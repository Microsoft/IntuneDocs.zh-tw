...
IT 系統管理員可以強制使用 [Intune Managed Browser 應用程式](../deploy-use/manage-internet-access-using-managed-browser-policies.md)開啟應用程式中的網頁連結。 這可確保出現在公司環境中的連結會保留在受 Intune 管理之應用程式的網域內。

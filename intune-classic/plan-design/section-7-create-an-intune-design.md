...
-   深入了解 [Intune 如何支援 Wi-Fi 設定檔。]/intune-classic/deploy-use/wi-fi-connections-in-microsoft-intune)
...
-   深入了解 [商務用 iOS 大量採購方案 /intune-classic/deploy-use/manage-ios-apps-you-purchased-through-a-volume-purchase-program-with-microsoft-intune))。

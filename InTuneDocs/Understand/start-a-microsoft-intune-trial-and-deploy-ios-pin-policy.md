...
title: 啟動 Microsoft Intune 試用版和部署 iOS PIN 原則 | Microsoft Intune
description:
keywords:
author: Staciebarker
manager: jeffgilb
...
1.  在 Windows 電腦上以滑鼠右鍵按一下 Internet Explorer (IE)，然後選取 [InPrivate 瀏覽]

    ![啟動 InPrivate 瀏覽](../media/30-day-trial-walkthrus/30day-start-trial-1-InPrivate.png)

2.  移至 [Intune 註冊入口網站](https://portal.office.com/Signup/Signup.aspx?OfferId=40BE278A-DFD1-470a-9EF7-9F2596EA7FF9&dl=INTUNE_A&ali=1)，提供要求的資訊，然後按 [下一步]
...
3.  建立原則的目標測試使用者群組︰
    ...
    3.  提供群組名稱，選取 [所有使用者] 作為父群組，然後按 [下一步]
...
4.  建立 iOS PIN 原則，並將測試使用者群組設定為其目標︰
    ...
    4.  輸入原則的名稱，開啟 [需要密碼來解除鎖定行動裝置] 選項，並將 [最小密碼長度] 設為 4

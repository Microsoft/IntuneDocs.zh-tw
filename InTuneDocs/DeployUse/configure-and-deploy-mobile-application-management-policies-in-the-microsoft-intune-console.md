...
description: "Microsoft Intune 中的行動應用程式管理原則可讓您修改您部署的應用程式的功能，使其符合公司相容性和安全性原則。"
keywords: 
author: robstackmsft
manager: arob98
ms.date: 07/19/2016

...
title: Windows 電腦的軟體更新 | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
# 在 Microsoft Intune 中使用軟體更新讓 Windows 電腦維持最新狀態
...
下表顯示您可以在原則中設定的值，以及在不自訂原則的情況下將使用的建議值。 您可以在 [更新]  區段中找到這些設定。
...
2.  在 [伺服器設定: 更新] 頁面的 [自動核准規則] 區段中，選擇 [新增]
...
2.  在 [自動核准規則]  區段中，選取規則，然後執行下列其中一項：
    ...
    -   若要編輯規則，請選擇 [編輯]，然後在 [更新自動核准規則精靈] 中變更規則的參數
...
|**核准**|核准選取的更新並讓您設定部署該更新的目標群組。 如需詳細資訊，請參閱本主題中的[核准更新](keep-windows-pcs-up-to-date-with-software-updates-in-microsoft-intune.md#BKMK_Approve)程序。|
...
3.  在 [選取群組] 頁面上，選取您要部署更新的目標群組，然後選擇 [新增]。 完成指定群組之後，請選擇 [下一步]。

...
>
> -   您必須先使用 [Apple Configurator 工具](https://itunes.apple.com/us/app/apple-configurator/id434433123?mt=12)或裝置註冊管理員，將裝置設為受監督模式，才能為 iOS 裝置設定 kiosk 模式。 如需 Apple Configurator 工具的詳細資訊，請參閱您的 Apple 文件。
...
### 監督
您可以在處於受監督模式且執行 iOS 7.1 和更新版本的裝置上進行下列設定。
...
|**允許主機配對，以控制 iOS 裝置所能配對的裝置**|允許主機配對讓系統管理員可控制 iOS 7 裝置所能配對的裝置。|

...
#### [Android 設定](android-policy-settings-in-microsoft-intune.md)
...
## [新增應用程式](add-apps.md)
### [新增應用程式至行動裝置](add-apps-for-mobile-devices-in-microsoft-intune.md)
### [新增應用程式至 Windows 電腦](add-apps-for-windows-pcs-in-microsoft-intune.md)

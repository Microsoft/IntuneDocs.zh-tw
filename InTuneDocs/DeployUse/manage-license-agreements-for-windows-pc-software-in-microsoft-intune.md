...
title: 在 Microsoft Intune 中管理 Windows 電腦軟體的授權合約 | Microsoft Intune
description:
keywords:
author: robstackmsft
manager: jeffgilb
...
Microsoft Intune 可讓您新增及管理透過 Microsoft 大量授權合約購買之軟體的授權合約資訊，以及透過其他方式購買的 Microsoft 或非 Microsoft 軟體的授權合約資訊。 您也可以將這項資訊組織成邏輯群組。

> [!IMPORTANT]
> 這項功能只是為了方便起見，並不保證其精確度， 因此不該完全仰賴它來確認是否遵守 Microsoft 大量授權合約。 Microsoft 不會使用收集的任何資料來調查您可能與我們簽訂之授權合約的可能違約情事或履約狀況。
> 
> 您新增至 Intune 的授權不會影響您的授權合約或軟體使用權利。  例如，從 Intune 中刪除授權/合約組並不會刪除您與 Microsoft 間存在的授權合約，或使合約失效。
...
1.  在 [Microsoft Intune 管理員主控台](https://account.manage.microsoft.com/admin/default.aspx)中，按一下 [授權].

2.  在 [新增合約] 頁面的 [選擇合約類型]下，選取 [大量授權合約].

3.  在 [新增合約詳細資料]  區段中，選擇下列其中一項：

    -   上傳內含合約詳細資料的 CSV 檔案 - 按一下 [瀏覽]，然後選取您要上傳的 CSV 檔案。
    ...
    -   手動新增合約詳細資料 - 提供下列資訊，然後在 [授權/合約編號] 和 [授權/註冊/客戶編號] 方塊中輸入合約編號組。 輸入這兩個編號後，請按一下 [新增合約組]  圖示以儲存編號，然後再選擇性地新增編號組。
        ...
        > [!NOTE]
        > 如果您新增幾合約編號組，Intune 會使用您指定的名稱建立一份合約，而您新增的所有編號組都會變成這份合約的一部分。

    您可以按一下 + 新增另一組合約編號，或者按一下 - 移除您已輸入的合約編號組。

4.  在 [選取授權群組]  區域中，執行下列其中一個步驟：

    -   將合約新增至未指派的合約群組：如果不想要將新合約新增到授權群組，請選取此選項。
...
[所有合約] 檢視隨即顯示，且 Intune 將會連線到 Microsoft 大量授權服務中心，以驗證您所提供的合約編號組。

當您在 Intune 中新增授權合約之後，若要更新大量授權資訊，請在 [授權概觀] 頁面中按一下 [立即重新整理]。 這個動作會從 [Microsoft 大量授權服務中心 (VLSC)](http://go.microsoft.com/fwlink/?LinkId=223842)擷取目前的授權資訊.
...
|-|-|
|工作|詳細資料|
|建立授權群組|在 [授權]  工作區的 [概觀]  頁面上，從 [工作]  功能表按一下 [建立授權群組]  。 附註：您可以建立總數高達 500 個授權群組。|
|重新命名授權群組|在 [授權]  工作區中，選擇授權群組，然後從 [工作]  功能表按一下 [編輯授權群組]  。|
|刪除授權群組|在 [授權]  工作區中，選擇授權群組，然後從 [工作]  功能表按一下 [刪除授權群組]  。 提示：已刪除之群組中的所有授權都會移到 [未指派的合約] 授權群組中。|
|刪除授權合約|在 [授權] 工作區中，選擇合約，然後按一下 [刪除]. 提示：在刪除大量授權合約之後，若要更新授權資訊，請在 [授權概觀] 頁面上或特定授權群組的 [一般] 索引標籤上，按一下 [立即重新整理]。|

...
若要整合 SDK，您需要存取應用程式的原始程式碼。 如需整合 SDK 的指示，請參閱 [Microsoft Intune App SDK](https://msdn.microsoft.com/library/mt627769.aspx).

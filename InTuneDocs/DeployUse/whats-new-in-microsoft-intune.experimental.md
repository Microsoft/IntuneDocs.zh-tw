...
以下是此版本中的新功能。 除了 Windows Defender 原則設定更新，所有這些功能亦支援混合式客戶的部署 (Configuration Manager 與 Intune)。 如需新混合式功能的詳細資訊，請查看我們的 [Hybrid What’s New](https://technet.microsoft.com/en-US/library/mt718155(TechNet.10).aspx) (混合式新功能) 頁面。

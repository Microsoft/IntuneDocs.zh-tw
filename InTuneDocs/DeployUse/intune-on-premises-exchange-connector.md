...
|將行動裝置管理授權單位設定為 Intune|[將行動裝置授權單位設定為 Intune](get-ready-to-enroll-devices-in-microsoft-intune.md#BKMK_Set_MDM_Authority)|
...
3.  在 [Exchange Server] 欄位中，選取您的 Exchange 伺服器環境類型是 [內部部署 Microsoft Exchange Server] 還是 [託管 Microsoft Exchange Server]

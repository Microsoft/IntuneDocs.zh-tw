---
title: "新增 Skycure 應用程式、Microsoft Authenticator 應用程式和 iOS 設定原則 | Microsoft Docs"
...
-   確定您已熟悉下列程序：
    ...
    -   [將應用程式新增至 Intune](https://docs.microsoft.com/intune/deploy-use/add-apps)。
...
[部署 Skycure 應用程式、Microsoft Authenticator 應用程式和 iOS 應用程式設定原則](https://docs.microsoft.com/intune/deploy-use/deploy-skycure-apps-microsoft-authenticator-app-and-ios-app-configuration-policy)

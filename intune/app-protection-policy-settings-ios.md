...
description: 此主題描述 iOS 裝置的應用程式保護原則設定。
keywords: ''
author: brenduns
ms.author: brenduns
manager: dougeby
...
ms.locfileid: "52728951"
---
#  <a name="ios-app-protection-policy-settings"></a>iOS 應用程式保護原則設定
[!INCLUDE [azure_portal](./includes/azure_portal.md)]

在 Azure 入口網站的 [新增原則] > [設定] 刀鋒視窗上，可以針對應用程式保護原則來[設定](app-protection-policies.md)此文章中所述的原則設定。

原則設定分為三類：「資料重新配置」、「存取需求」和「條件式啟動」。 在此文章中「受原則管理的應用程式」一詞是指設有應用程式保護原則的應用程式。

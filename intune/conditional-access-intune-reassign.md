...
4. 在 [指派] 區段下，選擇 [使用者和群組]，以新的條件式存取原則為目標。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的使用者群組 UI 比較的影像](./media/reassign-ca-1.png)
...
9. 按一下 [完成]。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的雲端應用程式 UI 比較的影像](./media/reassign-ca-3.png)
...
12. 完成選擇裝置平台後，請按兩下 [完成]。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的裝置平台 UI 比較的影像](./media/reassign-ca-4.png)
...
15. 完成選擇用戶端應用程式後，請按兩下 [完成]。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的用戶端應用程式 UI 比較的影像](./media/reassign-ca-6.png)
...
21. 在 [新增] 條件式存取原則刀鋒視窗中，開啟 [啟用原則] 切換，然後按一下 [建立]。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的啟用條件式存取原則 UI 比較的影像](./media/reassign-ca-11.png)
...
4. 在 [指派] 區段下，選擇 [使用者和群組]，以新的條件式存取原則為目標。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的使用者群組 UI 比較的影像](./media/reassign-ca-12.png)
...
7. 在 [雲端應用程式] 刀鋒視窗中，按一下 [選取應用程式] 並選擇 [Exchange Online]。 然後按一下 [選取] 和 [完成]。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的雲端應用程式 UI 比較的影像](./media/reassign-ca-14.png)
...
8. 在 [條件] 刀鋒視窗中，選擇 [用戶端應用程式]，然後選擇適用的用戶端應用程式。 如已選擇封鎖 Intune 不支援的用戶端，請使用 [僅將原則套用至支援的平台] 選項。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的用戶端應用程式 UI 比較的影像](./media/reassign-ca-15.png)
...
11. 在 [Grant Access Controls] \(授與存取控制)) 下，選擇 [裝置需要標記為相容]，然後按一下 [選取]。
    ...
    ![顯示 Intune 與 Azure 入口網站之間的授與存取權 UI 比較的影像](./media/reassign-ca-16.png)
...
4.  取消核取 [啟用 Exchange Online 的條件式存取原則] 選項，然後按一下 [儲存]。
    ...
    ![顯示 Intune 傳統入口網站中停用條件式存取原則的影像](./media/reassign-ca-18.png)

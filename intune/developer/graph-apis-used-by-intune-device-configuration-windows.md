---
title: 用來在 Microsoft Intune 中設定裝置的圖形 API - Azure | Microsoft Docs
titleSuffix: ''
description: 查看在 Microsoft Intune 中設定裝置時所使用的 Windows 10 及較新版本裝置上，具有相符 Windows CSP 和位移 URI 的所有圖形 API 實體清單。 查看適用於共用電腦、端點保護、Microsoft Defender 進階威脅防護、身分識別保護、Windows 10 團隊版、Kiosk 以及商務用 Windows Update 的相符 API 和 CSP。
keywords: ''
...
ms.locfileid: "77687813"
---
# <a name="graph-apis-and-matching-windows-10-csps-used-in-intune"></a>Intune 中使用的 Graph API 與相對應 Windows 10 CSP

Microsoft Intune 會使用[圖形 API 實體](https://docs.microsoft.com/graph/api/resources/intune-graph-overview) (開啟另一個 Docs 網站) 來設定執行 Windows 10 和更新版本的裝置 ([Intune]   > [裝置設定]  )。 圖形 API 使用設定服務提供者 (CSP) 來讀取、設定、變更及/或刪除裝置上的組態設定。
...
這項資訊適用於各種案例。 例如，查看 Intune 所使用的功能、查看要包含在自訂 OMA-URI 設定中的設定等。 

## <a name="windows-10-csps"></a>Windows 10 CSP

如需 Windows 10 設定服務提供者的詳細資訊，請參閱[設定服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (機器翻譯) (開啟另一個 Docs 網站)。

## <a name="graph-api-properties-to-csp-mapping"></a>圖形 API 屬性與 CSP 對應

下列清單顯示 Microsoft Intune 用於 Windows 10 裝置設定的大部分圖形 API 實體。 該清單也會顯示對應的 Windows 10 CSP 和位移 URI。

若要查看下列 API 適用的 Windows 10 版本，請使用 Windows 10 [設定服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (開啟另一個 Docs 網站)。
...
### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (Windows Holographic for Business 版本目標裝置) 
**CSP**：./Vendor/MSFT/AccountManagement  
**位移 URI**：/DeletionPolicy、/StorageCapacityStartDeletion、/StorageCapacityStopDeletion、/ProfileInactivityThreshold
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkSecurity\_LANManagerAuthenticationLevel
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Accounts\_RenameAdministratorAccount
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForAdministrators
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkAccess\_DoNotAllowAnonymousEnumerationOfSamAccountsAndShares
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkSecurity\_AllowPKU2UAuthenticationRequests
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkAccess\_RestrictClientsAllowedToMakeRemoteCallsToSAM
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Shutdown\_AllowSystemToBeShutDownWithoutHavingToLogOn
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_AllowUIAccessApplicationsToPromptForElevation
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_OnlyElevateUIAccessApplicationsThatAreInstalledInSecureLocations
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Devices\_AllowUndockWithoutHavingToLogon
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Accounts\_BlockMicrosoftAccounts
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Accounts\_LimitLocalAccountUseOfBlankPasswordsToConsoleLogonOnly
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Devices\_RestrictCDROMAccessToLocallyLoggedOnUserOnly
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Devices\_PreventUsersFromInstallingPrinterDriversWhenConnectingToSharedPrinters
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Shutdown\_ClearVirtualMemoryPageFile
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsAlways
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_SendUnencryptedPasswordToThirdPartySMBServers
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_DetectApplicationInstallationsAndPromptForElevation
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Accounts\_EnableAdministratorAccountStatus
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsIfServerAgrees
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Accounts\_EnableGuestAccountStatus
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsAlways
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsIfClientAgrees
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkAccess\_DoNotAllowAnonymousEnumerationOfSAMAccounts
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotRequireCTRLALTDEL
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkSecurity\_DoNotStoreLANManagerHashValueOnNextPasswordChange
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Devices\_AllowedToFormatAndEjectRemovableMedia
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/Accounts\_RenameGuestAccount
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayLastSignedIn
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayUsernameAtSignIn
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DisplayUserInformationWhenTheSessionIsLocked
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTextForUsersAttemptingToLogOn
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTitleForUsersAttemptingToLogOn
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MachineInactivityLimit
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedClients
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedServers
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_OnlyElevateExecutableFilesThatAreSignedAndValidated
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/NetworkAccess\_RestrictAnonymousAccessToNamedPipesAndShares
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/InteractiveLogon\_SmartCardRemovalBehavior
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForStandardUsers
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_SwitchToTheSecureDesktopWhenPromptingForElevation
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_UseAdminApprovalMode
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_RunAllAdministratorsInAdminApprovalMode
...
**CSP**：./Vendor/MSFT/Policy  
**位移 URI**：/Config/LocalPoliciesSecurityOptions/UserAccountControl\_VirtualizeFileAndRegistryWriteFailuresToPerUserLocations
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/RemoteManagement/AllowBasicAuthentication\_Client
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/RemoteManagement/AllowUnencryptedTraffic\_Client
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/RemoteManagement/AllowBasicAuthentication\_Service
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/RemoteManagement/AllowUnencryptedTraffic\_Service
...
**CSP**：N/A 僅限圖形 API 呼叫 **位移 URI**：N/A 僅限圖形 API 呼叫
...
**位移 URI**：/MOMAgent/WorkspaceID 和 /MOMAgent/WorkspaceKey
...
**CSP**：N/A - 僅限圖形 API **位移 URI**：N/A - 僅限圖形 API
...
**CSP**：./Device/Vendor/MSFT/Policy  
**位移 URI**：/Config/Update/ScheduledInstallEveryWeek、/Config/Update/ScheduledInstallFirstWeek、/Config/Update/ScheduledInstallFourthWeek、/Config/Update/ScheduledInstallSecondWeek、/Config/Update/ScheduledInstallThirdWeek
...
- [裝置設定概觀](../configuration/device-profiles.md)
- [設定服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (開啟另一個 Docs 網站)

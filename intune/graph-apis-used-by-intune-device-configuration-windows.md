---
title: 圖形 Api 來設定裝置在 Microsoft Intune-Azure |Microsoft Docs
titleSuffix: ''
description: 查看具有相符的 Windows CSP 的所有 Graph API 實體清單，並在 Microsoft Intune 中設定裝置時，會使用位移 URI 和更新版本的 Windows 10 裝置上。 共用的電腦、 endpoint protection、 Windows Defender 進階威脅防護、 身分識別保護、 Windows 10 團隊、 kiosk、 及 Windows Update for Business，請參閱 「 比對的 API 和 CSP。
keywords: ''
...
ms.locfileid: "61514152"
---
# <a name="graph-apis-and-matching-windows-10-csps-used-in-intune"></a>Graph Api，並符合在 Intune 中使用的 Windows 10 Csp

使用 Microsoft Intune [Graph API 實體](https://docs.microsoft.com/graph/api/resources/intune-graph-overview)（開啟另一個文件網站） 來設定裝置 (**Intune** > **裝置組態**) 執行 Windows 10和更新版本。 Graph API 會使用組態服務提供者 (Csp) 來讀取、 設定、 變更，和/或刪除裝置上的組態設定。

此清單適用於：

- Windows 10 及更新版本

本文列出圖表實體和其對應的 Windows 10 Csp 和位移的 Uri。

這項資訊可用於各種案例。 比方說，Intune 會使用什麼，請參閱設定，以在 自訂 OMA URI 設定，包括等等。 

## <a name="windows-10-csps"></a>Windows 10 的 Csp

如需有關 Windows 10 組態服務提供者的詳細資訊，請參閱 <<c0> [ 組態服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference)（開啟另一個文件網站）。

## <a name="graph-api-properties-to-csp-mapping"></a>Graph API 與 CSP 之間的對應的屬性

下列清單顯示大部分的 Windows 10 裝置設定 Microsoft Intune 所使用的 Graph API 實體。 它也會顯示相對應的 Windows 10 CSP 和位移的 URI。

若要查看下列 Api 適用於 Windows 10 版本，請使用 Windows 10[組態服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference)（開啟另一個文件網站）。
...
**位移 URI**: /DeletionPolicy、 /DiskLevelCaching、 /InactiveThreshold、 /DiskLevelDeletion

#### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (Windows Holographic for Business edition 的目標裝置) 
...
**CSP**:./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**位移 URI**: / 設定/BlockNonEnterpriseContent
...
**CSP**:./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**位移 URI**： 稽核/AuditApplicationGuard
...
**CSP**:./Device/Vendor/MSFT/BitLocker  
**位移 URI**: /EncryptionMethodByDriveType /FixedDrivesRequireEncryption、 /FixedDrivesRecoveryOptions
...
**CSP**:./Device/Vendor/MSFT/BitLocker  
**位移 URI**: /EncryptionMethodByDriveType、 /RemovableDrivesRequireEncryption
...
**CSP**:./Device/Vendor/MSFT/BitLocker  
**位移 URI**: /EncryptionMethodByDriveType、 /SystemDrivesRequireStartupAuthentication、 /SystemDrivesMinimumPINLength、 /SystemDrivesRecoveryMessage、 /SystemDrivesRecoveryOptions
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/Defender/ControlledFolderAccessProtectedFolders
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/ExploitGuard/ExploitProtectionSettings
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/Defender/ControlledFolderAccessAllowedApplications
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/Defender/EnableNetworkProtection
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/WindowsDefenderSecurityCenter/DisallowExploitProtectionOverride
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**: WindowsDefenderSecurityCenter/EnableCustomizedToasts、 WindowsDefenderSecurityCenter/EnableInAppCustomization
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/DeviceGuard/EnableVirtualizationBasedSecurity
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_LANManagerAuthenticationLevel
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameAdministratorAccount
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForAdministrators
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_DoNotAllowAnonymousEnumerationOfSamAccountsAndShares
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_AllowPKU2UAuthenticationRequests
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Shutdown\_AllowSystemToBeShutDownWithoutHavingToLogOn
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_AllowUIAccessApplicationsToPromptForElevation
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_OnlyElevateUIAccessApplicationsThatAreInstalledInSecureLocations
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Devices\_AllowUndockWithoutHavingToLogon
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Accounts\_BlockMicrosoftAccounts
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Accounts\_LimitLocalAccountUseOfBlankPasswordsToConsoleLogonOnly
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Devices\_RestrictCDROMAccessToLocallyLoggedOnUserOnly
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Devices\_PreventUsersFromInstallingPrinterDriversWhenConnectingToSharedPrinters
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Shutdown\_ClearVirtualMemoryPageFile
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsAlways
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_SendUnencryptedPasswordToThirdPartySMBServers
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_DetectApplicationInstallationsAndPromptForElevation
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableAdministratorAccountStatus
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsIfServerAgrees
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableGuestAccountStatus
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsAlways
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsIfClientAgrees
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotRequireCTRLALTDEL
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_DoNotStoreLANManagerHashValueOnNextPasswordChange
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Devices\_AllowedToFormatAndEjectRemovableMedia
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameGuestAccount
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DoNotDisplayUsernameAtSignIn
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DisplayUserInformationWhenTheSessionIsLocked
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTextForUsersAttemptingToLogOn
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MessageTitleForUsersAttemptingToLogOn
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MachineInactivityLimit
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedClients
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_MinimumSessionSecurityForNTLMSSPBasedServers
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_OnlyElevateExecutableFilesThatAreSignedAndValidated
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/NetworkAccess\_RestrictAnonymousAccessToNamedPipesAndShares
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_SmartCardRemovalBehavior
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_BehaviorOfTheElevationPromptForStandardUsers
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_SwitchToTheSecureDesktopWhenPromptingForElevation
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_UseAdminApprovalMode
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_RunAllAdministratorsInAdminApprovalMode
...
**CSP**:./Vendor/MSFT/Policy  
**URI 的位移**: /Config/LocalPoliciesSecurityOptions/UserAccountControl\_VirtualizeFileAndRegistryWriteFailuresToPerUserLocations
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/RemoteManagement/AllowBasicAuthentication\_用戶端
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/RemoteManagement/AllowUnencryptedTraffic\_用戶端
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/RemoteManagement/AllowBasicAuthentication\_服務
...
**CSP**:./Device/Vendor/MSFT/Policy  
**URI 的位移**: /Config/RemoteManagement/AllowUnencryptedTraffic\_服務
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/DeviceGuard/RequirePlatformSecurityFeatures
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/SmartScreen/EnableSmartScreenInShell
...
**CSP**:N/A 圖形 API 呼叫只**位移 URI**:僅在 n/A Graph API 呼叫
...
**位移 URI**: /ProxyAddress、 /Exceptions 和 /UseProxyForLocalAddresses
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**: /Config/NetworkIsolation/EnterpriseCloudResources /Config/NetworkIsolation/EnterpriseIPRange、 /Config/NetworkIsolation/EnterpriseIPRangesAreAuthoritative、 /Config/NetworkIsolation /EnterpriseInternalProxyServers /Config/NetworkIsolation/EnterpriseNetworkDomainNames、 /Config/NetworkIsolation/EnterpriseProxyServers、 /Config/NetworkIsolation/EnterpriseProxyServersAreAuthoritative、 /Config/NetworkIsolation /NeutralResources
...
**位移 URI**: MOMAgent/WorkspaceID 和 WorkspaceKey MOMAgent /
...
**CSP**:./Vendor/MSFT/SurfaceHub  
**位移 URI**: /MaintenanceHoursSimple/Hours/Duration 和 /MaintenanceHoursSimple/Hours/StartTime
...
**CSP**:./Vendor/MSFT/SurfaceHub  
**位移 URI**: InBoxApps WirelessProjection/通道
...
**CSP**:./Vendor/MSFT/SurfaceHub  
**位移 URI**: / 屬性/DoNotShowMyMeetingsAndFiles
...
**CSP**:./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**位移 URI**: / 組態/TelemetryReportingFrequency
...
**位移 URI**： 生物識別技術/FacialFeaturesUseEnhancedAntiSpoofing
...
**位移 URI**: / {AADTenantId} / 原則/PINComplexity/到期日
...
**CSP**:./Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則/PINComplexity/歷程記錄
...
**CSP**:./Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則//policies/enablepinrecovery
...
**CSP**:./Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則/PINComplexity/SpecialCharacters
...
**CSP**:./Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則/PINComplexity/大寫與
...
**CSP**:./Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則/RequireSecurityDevice
...
**CSP**:./Device/Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則/UseCertificateForOnPremAuth
...
**CSP**:./Vendor/MSFT/PassportForWork  
**位移 URI**: / {AADTenantId} / 原則/UsePassportForWork
...
**CSP**:N/A-Graph API 只能**位移 URI**:N/A-只圖形 API
...
**CSP**:./Device/Vendor/MSFT/Policy**位移 URI**: /Config/Update/ActiveHoursStart、 /Config/Update/ActiveHoursEnd、 /Config/Update/ScheduledInstallDay、 /Config/Update/ScheduledInstallTime
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**: /Config/Update/ScheduledInstallEveryWeek /Config/Update/ScheduledInstallFirstWeek、 /Config/Update/ScheduledInstallFourthWeek、 /Config/Update/ScheduledInstallSecondWeek、 /Config/更新 /ScheduledInstallThirdWeek
...
- [裝置設定概觀](device-profiles.md)
- [組態服務提供者參考](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference)（開啟另一個文件網站）

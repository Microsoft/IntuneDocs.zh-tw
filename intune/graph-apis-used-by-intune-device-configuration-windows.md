...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**:/CONFIG/DEFENDER/ATTACKSURFACEREDUCTIONRULES (CSP/Configuration 需要圖形屬性: Windows10endpointprotection/defenderOfficeAppsOtherProcessInjectionType、windows10endpointprotection/DefenderOfficeAppsExecutableContentCreationOrLaunchType、windows10endpointprotection/defenderOfficeAppsLaunchChildProcessType、windows10endpointprotection/DefenderOfficeMacroCodeAllowWin32ImportsType、windows10endpointprotection/defenderScriptObfuscatedMacroCodeType、windows10endpointprotection/Configuration. defenderScriptDownloadedPayloadExecutionType、windows10endpointprotection/defenderEmailContentExecutionType、windows10endpointprotection/Configuration. defenderPreventCredentialStealingType、windows10endpointprotection/DefenderUntrustedUSBProcessType
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**:/Config/RemoteManagement/AllowBasicAuthentication\_用戶端
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**:/Config/RemoteManagement/AllowUnencryptedTraffic\_用戶端
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**:/Config/RemoteManagement/AllowBasicAuthentication\_服務
...
**CSP**:./Device/Vendor/MSFT/Policy  
**位移 URI**:/Config/RemoteManagement/AllowUnencryptedTraffic\_服務
...
**CSP**:N/A 圖形 API 只呼叫**位移 URI**:僅限 N/A 圖形 API 呼叫
...
**CSP**:N/A-僅圖形 API**位移 URI**:僅限 N/A-圖形 API

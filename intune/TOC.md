...
### [決定長期與短期目標](planning-guide-deployment-goals.md)
### [識別案例](planning-guide-scenarios.md)
...
#### [裝置註冊計劃](device-enrollment-program-enroll-ios.md)
...
#### [Microsoft 網上商店應用程式](store-apps-windows.md)
...
#### [適用於 iOS 的共用裝置](shared-device-settings-ios.md)
#### [適用於 iOS 的網站篩選設定](web-content-filter-settings-ios.md)

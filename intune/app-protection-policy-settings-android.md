...
| **需要最低的 Android 作業系統** | 選擇 [是] 以要求使用此應用程式的最低 Android 作業系統。 如果裝置上的 Android 版本不符合需求，將會禁止使用者進行存取。 <br><br> | 否 |
| **需要最低的 Android 作業系統 (僅警告)** | 選擇 [是] 以建議使用此應用程式的最低 Android 作業系統。 如果裝置上的 Android 版本不符合需求，使用者將會看見通知。 此通知可以關閉。 <br><br> | 否 |

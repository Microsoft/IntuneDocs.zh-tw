...
本節提及裝置系統管理員（DA）和 Samsung Knox 註冊。 如需詳細資訊，請參閱[android 裝置系統管理員註冊](android-enroll-device-administrator.md)和[使用 Samsung Knox Mobile 註冊自動註冊 android 裝置](android-samsung-knox-mobile-enroll.md)。 

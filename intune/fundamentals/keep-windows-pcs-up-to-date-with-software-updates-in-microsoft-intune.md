...
> [!NOTE]
> 本主題中的資訊僅適用於使用 Intune 軟體用戶端作為電腦所管理的 Windows 桌上型電腦。 如果您想要管理註冊為行動裝置之 Windows 電腦的更新，請參閱[在 Intune 中管理軟體更新](../protect/windows-update-for-business-configure.md)。

...
#### <a name="we-have-updated-two-device-restriction-settings-for-ios-and-ipados-devices-to-correct-their-behavior---5701352-wnready-----"></a>我們已更新適用於 iOS 和 iPadOS 裝置的兩個裝置限制設定，以更正其行為<!-- 5701352 WNReady   -->

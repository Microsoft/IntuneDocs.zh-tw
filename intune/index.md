            ...
            <ul id="manage">
                <li>
                    ...
                    <ul id="manage-featured" class="cardsC">
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">熱門文章</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">建議文章</h3>
                            </div>
                        </li>
                        <li>
                            <div>
                                <h3 style="font-size: 1.4rem; margin-top: 0px; margin-left: 11px;">新文章</h3>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Azure 入口網站中的 Intune</h3>
                                            <p>在 Azure 入口網站中，現在已可使用 Microsoft Intune。 了解在新入口網站中管理裝置與應用程式。 </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>什麼是 Intune 教育版？</h3>
                                            <p>了解如何使用教室中的裝置來完成日常事項。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>開始使用 Intune</h3>
                                            <p>了解基本概念：建立群組和使用者。 註冊裝置。 指派原則和應用程式。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>150 台以上的授權？ 利用 FastTrack 權益</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>我的 Intune 功能移到 Azure 中的哪個位置？</h3>
                                            <p>如果您熟悉傳統主控台中的 Intune，本文可協助您在 Azure 中尋找 Intune 功能。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>請參閱<a href="/intune/what-is-intune">所有 Intune 文件</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>請參閱<a href="/intune/what-is-intune">所有簡介文件</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>請參閱<a href="/intune-classic/plan-design/introduction">所有規劃部署文件</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>請參閱<a href="/intune/device-enrollment">所有做法文件</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>請參閱<a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">所有疑難排解文件</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>在尋找所有文件嗎？ 請參閱<a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">所有 Intune 文件</a>。</h3>
                            </div>
                        </li>
                    </ul>
                </li>

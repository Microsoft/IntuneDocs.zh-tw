...
IT 系統管理員可以強制使用 [Intune Managed Browser 應用程式](app-configuration-managed-browser.md)開啟應用程式中的網頁連結。 此功能可確保出現在公司環境中的連結會保留在受 Intune 管理之應用程式的網域內。

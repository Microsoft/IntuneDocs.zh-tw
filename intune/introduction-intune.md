...
Intune 是企業行動管理 (EMM) 的雲端式服務，可協助讓您的公司員工有更高的生產力，並同時保護公司的各種資料及客戶的隱私不會外洩。 使用 Intune，您可以︰
* 管理您公司的員工用來存取公司資料的行動裝置。
* 管理您公司的員工所使用的行動應用程式。
* 藉由協助控制您公司的員工存取並共用公司資訊的方式，保護您的公司重要資訊不會外洩。
* 確保裝置和應用程式都符合公司各種安全性管理需求。

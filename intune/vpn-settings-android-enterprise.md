...
Intune 管理員，您可以建立及指派 VPN 設定至 Android Enterprise 裝置。 

若要深入瞭解 Intune 中的 VPN 設定檔，請參閱[vpn 設定檔](vpn-settings-configure.md)。

## <a name="before-you-begin"></a>開始之前

[建立裝置設定檔](vpn-settings-configure.md#create-a-device-profile)，然後選擇 [ **Android Enterprise**]。

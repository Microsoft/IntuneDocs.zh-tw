...
description: "了解如何使用 Intune 為公司擁有的 iOS 裝置設定 Apple School Manager 計劃註冊 (新 UI)\""
keywords: 
author: ErikjeMS
ms.author: erikje
manager: dougeby
...
>
>否則，如果您的**裝置註冊**頁面如下圖所示，代表您的帳戶尚未更新至新的使用者介面。 移至[此說明頁面](apple-school-manager-set-up-ios.md)。
>

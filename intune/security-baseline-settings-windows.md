...
ms.locfileid: "66749922"
---
# <a name="windows-security-baseline-settings-for-intune"></a>適用於 Intune 的 Windows 安全性基準設定  

檢視 Microsoft Intune 支援的 [Windows 安全性基準設定](security-baselines.md)。 Windows 基準預設值代表 Windows 建議的設定，可能不符合其他安全性基準的基準預設值。  

> [!NOTE]  
> Windows 安全性基準設定現為**預覽**。 在預覽狀態中，可用設定清單以及此內容呈現那些設定的順序將視入口網站中提供的項目而異。  
>  

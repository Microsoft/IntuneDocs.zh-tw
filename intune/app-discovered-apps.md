...
> [!NOTE]
>包含 Intune 管理延伸模組的 Windows 10 混合式 Azure AD 加入裝置，目前不會根據上述排程收集應用程式清查。 這是已知的問題。 此行為的任何變更或更新，都會在[開發中](in-development.md)和/或[新功能](whats-new.md)中公告。

...
在您開始疑難排解問題之前，請確定您的 Intune 設定正確，可以註冊。 如需每個平台的註冊步驟連結，請參閱[註冊 Android 與 Standard Knox 裝置](android-enroll.md)。
...
> 如[使用裝置註冊管理員註冊裝置](device-enrollment-manager-enroll.md)中所述，您可以使用裝置註冊管理員避開裝置註冊上限。
>
...
要求您的使用依照[您的裝置遺漏必要的憑證](https://docs.microsoft.com/intune-user-help/your-device-is-missing-a-required-certificate-landing-android#your-device-is-missing-a-certificate-required-by-your-it-administrator)中的指示解決問題。 如果使用者依照指示進行之後仍出現錯誤，請嘗試「解決方法 2」。
...
您可以檢視可能會對使用者顯示的 [iOS 註冊錯誤](https://docs.microsoft.com/intune-user-help/you-see-errors-while-trying-to-enroll-your-device-in-intune-ios)清單。 此清單提供的資訊包括可能會對使用者顯示的錯誤訊息，以及您解決此問題所要採取的步驟。

...
|使用者可用|裝置解除安裝|同時存在，閘道解析可用。<br><br>應用程式在 [公司入口網站] 中顯示。<br><br>如果已經安裝該應用程式 (如含上一個用途的必要應用程式)，會將該應用程式解除安裝。<br><br>如果使用者選取 [從公司入口網站安裝]，會安裝該應用程式，而不會接受解除安裝的用途。|
|使用者無法使用|裝置為必要|必要|
|使用者無法使用|裝置解除安裝|解除安裝|
...
|使用者為必要且可用|裝置解除安裝|同時存在，閘道解析為必要 (必要且可用)
|使用者無法使用|裝置無法使用|無法使用|
|使用者可用|裝置無法使用|可用|
|使用者為必要|裝置無法使用|必要|

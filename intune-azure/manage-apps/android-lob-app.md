---
title: "如何將 Android 企業營運應用程式新增至 Intune | Intune Azure 預覽版 | Microsoft Docs"
...
# <a name="how-to-add-android-line-of-business-lob-apps-to-intune"></a>如何將 Android 企業營運應用程式 (LOB) 新增至 Intune
...
在 [選取安裝檔] 刀鋒視窗中按一下 [瀏覽] 按鈕，並瀏覽至 Android 應用程式安裝檔 (副檔名為 .apk)，然後按一下 [確定]。

---
title: "如何將 Android 市集應用程式新增至 Intune | Intune Azure 預覽版 | Microsoft Docs"
description: "Intune Azure 預覽版︰了解如何將 Android 市集應用程式新增至 Intune。"
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-android-store-apps-to-intune"></a>如何將 Android 市集應用程式新增至 Intune

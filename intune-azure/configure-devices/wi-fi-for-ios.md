---
title: "iOS 裝置的 Intune Wi-Fi 設定 | Intune Azure 預覽版 | Microsoft Docs"
...
# <a name="intune-wi-fi-settings-for-ios-devices-in-intune-azure-preview"></a>Intune Azure 預覽版中 iOS 裝置的 Wi-Fi 設定

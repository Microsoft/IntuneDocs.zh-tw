---
title: "適用於 macOS 的 Intune 裝置限制設定 | Intune Azure 預覽版 | Microsoft Docs"
...
# <a name="macos-device-restriction-settings-in-intune-azure-preview"></a>Intune Azure 預覽版中 macOS 裝置限制設定

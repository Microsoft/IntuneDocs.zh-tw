---
title: "Windows Phone 8.1 裝置的 Intune VPN 設定 | Intune Azure 預覽版 | Microsoft Docs"
...
# <a name="vpn-settings-for-windows-phone-81-devices-in-intune-azure-preview"></a>Intune Azure 預覽版中 Windows Phone 8.1 裝置的 VPN 設定

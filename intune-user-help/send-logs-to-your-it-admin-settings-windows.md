...
---
# <a name="send-logs-to-your-it-admin-from-the-settings-app-for-windows-10"></a>針對 Windows 10 將記錄檔從設定應用程式傳送給 IT 系統管理員

如果您在使用公司所管理的 Windows 10 裝置時出現錯誤，則可以使用電子郵件將資訊傳送給 IT 系統管理員，以協助他們針對問題進行疑難排解。 這項資訊會保留在裝置中名為 _diagnostic log_ 的特殊文件中。
...
您可能也需要傳送[公司入口網站應用程式中的記錄檔](send-logs-to-your-it-admin-cp-windows.md)，更進一步地協助 IT 系統管理員嘗試將他們可能發現的任何問題進行疑難排解。 
